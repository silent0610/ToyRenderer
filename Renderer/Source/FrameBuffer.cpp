...
FramebufferManager::FramebufferManager(OldVulkanDevice* vulkanDevice)
{
	assert(vulkanDevice);
...
*/
uint32_t FramebufferManager::AddAttachment(AttachmentCreateInfo createinfo)
{
...
*/
VkResult FramebufferManager::CreateSampler(VkFilter magFilter, VkFilter minFilter, VkSamplerAddressMode adressMode)
{
...
*/
VkResult FramebufferManager::CreateRenderPass()
{
